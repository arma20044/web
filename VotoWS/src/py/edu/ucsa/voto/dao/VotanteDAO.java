...
public class VotanteDAO extends AbstractSpringDAO implements VotanteDAOInterface {
  ...
  public UcsawsVotante obtenerVotante(Integer idPersona) {
    ...
    String hql;
    hql =
        "select obj from " + claseEntidad + " obj where idPersona.idPersona = :idVotante"
  ...
  public UcsawsVotante obtenerVotanteSinSufragar(String idPersona) {
    ...
    String hql;
    hql =
        "select obj from " + claseEntidad + " obj where idPersona.idPersona = :idPersona"
            + " and habilitado = :habilitado and sufrago = :sufrago";
    Query query = em.createQuery(hql);
  ...
  public UcsawsVotante obtenerVotanteByIdPersonaYEvento(Integer idPersona, Integer idEvento) {
    List<UcsawsVotante> resultado;
    UcsawsVotante e = new UcsawsVotante();
    String hql;
    hql = "select obj from " + claseEntidad + " obj where idEvento.idEvento =:idEvento and idPersona.idPersona =:idPersona";
    Query query = em.createQuery(hql);
